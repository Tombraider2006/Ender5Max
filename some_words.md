...
тензодатчики от креалити..  это будет первое от чего надо избавляться при переходе на обычный клиппер. кстати сказать, пока работают неплохо.
...
максимальное ускорение в сто тысяч. явный косяк разработки максимум 20-25 тысяч надо было ставить. 
...
#max_freq:90
```
да... , и к этой части конфига будут претензии..  во первых. вы сначала тестили на 75 герцах, потом на 90 потом закоментили... зачем?  зачем опустили до 50? нет, я знаю зачем до 50, потому что у вас 400 мм портал. но блин.. 
...
lft_k1_cal: 0.95
```
 часть фильтра акселерометра? а что случилось? 
```
[dirzctl]
use_mcu: mcu
step_base: 2
...
несколько букв, один параметр, насколько облегчится жизнь печатника..

исключение обьектов - одна из самых основновных фишек клиппера которую забыли вписать в конфиг... 
