...
Если вы захотите использовать guppyscreen то необходимо певернуть экран. вот [**модель**](/mans/Ender5MaxTiltedScreenMount.stl) чтобы закрепить экран в горизонтальном положении.
